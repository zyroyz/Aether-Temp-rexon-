...
new ButtonInfo[] { // Main Mods
                ...
                new ButtonInfo { buttonText = "example", method =() => SettingsMods.example(), isTogglable = false, toolTip = "Opens the projectile settings for the menu."},
            },

            new ButtonInfo[] { // Menu Settings
                new ButtonInfo { buttonText = "home", method =() => Global.ReturnHome(), isTogglable = false, toolTip = "Opens the home page for the menu."},
